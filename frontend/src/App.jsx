...
function Wordmark() {
  return <a className="wordmark logo-link" href="#top" aria-label="The World Migration home"><img className="brand-logo" src={brandLogo} alt="The Migration Firm International" width="2031" height="774" /></a>;
}
  ...
  return <>
    ...
    <header className="site-header"><div className="wrap header-row"><Wordmark />
      <nav id="navigation" className={menu ? 'navigation open' : 'navigation'} aria-label="Main navigation">
        ...
        <a className="button header-cta" href="#contact" onClick={() => setMenu(false)}>Book a consultation <ArrowUpRight size={15} /></a>
    ...
    <main id="main">
      <section className="hero" id="top">
        ...
        <div className="wrap hero-layout"><div className="hero-copy"><span className="eyebrow light"><span /> A WORLD OF POSSIBILITY</span>
          ...
          <div className="hero-actions"><a className="button gold" href="#contact"><Editable name="hero_button"/> <ArrowUpRight size={18} /></a><a className="text-link" href="#destinations">Explore destinations <ArrowDown size={15} /></a></div>
